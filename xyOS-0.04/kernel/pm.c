...
{	
	...
	/*初始化异常描述符*/
	init_idt_des ((u32) hwint01, DPL0, IDT_INT, IRQ0_VECTOR);
	init_idt_des ((u32) hwint02, DPL0, IDT_INT, IRQ1_VECTOR);
	init_idt_des ((u32) hwint03, DPL0, IDT_INT, IRQ2_VECTOR);
	init_idt_des ((u32) hwint04, DPL0, IDT_INT, IRQ3_VECTOR);
	init_idt_des ((u32) hwint05, DPL0, IDT_INT, IRQ4_VECTOR);
	init_idt_des ((u32) hwint06, DPL0, IDT_INT, IRQ5_VECTOR);
	init_idt_des ((u32) hwint07, DPL0, IDT_INT, IRQ6_VECTOR);
	init_idt_des ((u32) hwint08, DPL0, IDT_INT, IRQ7_VECTOR);
	init_idt_des ((u32) hwint09, DPL0, IDT_INT, IRQ8_VECTOR);
	init_idt_des ((u32) hwint10, DPL0, IDT_INT, IRQ9_VECTOR);
	init_idt_des ((u32) hwint11, DPL0, IDT_INT, IRQ10_VECTOR);
	init_idt_des ((u32) hwint12, DPL0, IDT_INT, IRQ11_VECTOR);
	init_idt_des ((u32) hwint13, DPL0, IDT_INT, IRQ12_VECTOR);
	init_idt_des ((u32) hwint14, DPL0, IDT_INT, IRQ13_VECTOR);
	init_idt_des ((u32) hwint15, DPL0, IDT_INT, IRQ14_VECTOR);
